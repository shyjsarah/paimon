...
public class DLFAuthOpenAPIAuthProvider implements AuthProvider {

    private static final Logger LOG = LoggerFactory.getLogger(DLFAuthOpenAPIAuthProvider.class);
    ...
    public static final String DLF_DATE_HEADER_KEY = "x-acs-date";
    public static final String DLF_SECURITY_TOKEN_HEADER_KEY = "x-acs-security-token";
    public static final String DLF_AUTH_VERSION_HEADER_KEY = "x-acs-version";
    public static final String DLF_CONTENT_SHA56_HEADER_KEY = "x-acs-content-sha256";
    ...
    public static DLFAuthOpenAPIAuthProvider fromTokenLoader(DLFTokenLoader tokenLoader, String region) {
        return new DLFAuthOpenAPIAuthProvider(tokenLoader, null, region);
    }

    public static DLFAuthOpenAPIAuthProvider fromAccessKey(
        ...
        return new DLFAuthOpenAPIAuthProvider(null, token, region);
    }

    public DLFAuthOpenAPIAuthProvider(
    ...
    public Map<String, String> mergeAuthHeader(
        ...
        try {
            ...
            headersWithAuth.put("x-acs-action","ListTables");
    ...
    public static Map<String, String> generateSignHeaders(
        ...
        signHeaders.put(DLF_AUTH_VERSION_HEADER_KEY, "2026-01-18");
