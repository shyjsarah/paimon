...
/** Factory for {@link DLFAuthOpenAPIAuthProvider}. */
public class DLFAuthOpenAPIProviderFactory implements AuthProviderFactory {

    @Override
    public String identifier() {
        return AuthProviderEnum.DLF_OPEN_API.identifier();
    }
    ...
    public AuthProvider create(Options options) {
        ...
        if (options.getOptional(RESTCatalogOptions.DLF_TOKEN_LOADER).isPresent()) {
            ...
            return DLFAuthOpenAPIAuthProvider.fromTokenLoader(dlfTokenLoader, region);
            ...
            return DLFAuthOpenAPIAuthProvider.fromAccessKey(
